...
function sl_render_products(array $products, string $url, int $page, int $size, int $total_pages): void
{
...
sl_render_products($products, "/products", $page, $page_size, $total_pages);
